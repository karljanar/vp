...
?>
    ...
    <?php echo $imghtml; ?>
    <hr>
     <div style="width:80%;height:0px;position:relative;padding-bottom:75.000%;" class="center"><iframe src="https://streamable.com/e/4jljlx?loop=0" frameborder="0" width="80%" height="80%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div>
</body>
</html>